...
function SortIcon({ direction }) {
  ...
  return direction === 'asc' ? (
    <svg className="ml-1 inline h-3.5 w-3.5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <th key={col.key} className="whitespace-nowrap px-4 py-3 font-semibold text-estate-600">
                    {col.sortable ? (
                      <button
                        ...
                        className="inline-flex items-center gap-0.5 transition-colors hover:text-blue-600"
                      >
                        {col.label}
