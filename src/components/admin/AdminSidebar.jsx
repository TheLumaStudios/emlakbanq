...
const useNavItems = () => {
  ...
  return [
    ...
    {
      to: '/admin/golden-visa',
      label: t('admin.nav.goldenVisa'),
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function AdminSidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-estate-900 transition-transform duration-300 lg:translate-x-0',
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b border-white/10 px-6">
          ...
          <button
            onClick={onClose}
            className="rounded-md p-1 text-white/60 transition-colors hover:bg-white/10 hover:text-white lg:hidden"
