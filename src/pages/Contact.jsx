...
export default function Contact() {
  ...
  const CONTACT_INFO = [
    ...
    },
    {
      ...
      value: t('contact.info.phone', '+90 242 XXX XXXX'),
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      value: t('contact.info.whatsapp', '+90 532 XXX XXXX'),
      icon: (
    ...
    },
    {
      ...
      value: t('contact.info.workingHoursValue', 'Pzt - Cum: 9:00 - 18:00 (TR)'),
      icon: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <div className="grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={form.phone}
                        onChange={handleChange}
                        placeholder={t('contact.form.placeholders.phone', '+90 532 XXX XXXX')}
                        className={inputClass}
                      />
                    </div>
                  </div>
